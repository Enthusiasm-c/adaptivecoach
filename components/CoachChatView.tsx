...
const CoachChatView: React.FC<CoachChatViewProps> = ({
    ...
    return (
        <div className="flex flex-col h-full bg-[#0a0a0a]">
                    ...
                    <div className="space-y-4 pt-4">
                            ...
                            <div key={index} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                ...
                                <div className={`max-w-[80%] rounded-2xl p-4 ${
                                    msg.role === 'user'
                                        ...
                                        : 'bg-[#1a1a1a] border border-white/5 rounded-bl-md'
                                }`}>
                        ...
                        {isLoading && (
                            <div className="flex gap-3 justify-start">
                                ...
                                <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl rounded-bl-md p-4">
            ...
            <div className="fixed bottom-24 left-0 right-0 px-4 pb-4 pt-3 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a] to-transparent">
                <form onSubmit={handleSend} className="max-w-lg mx-auto">
                    <div className="flex items-center gap-2 bg-[#1a1a1a] border border-white/10 rounded-2xl p-1.5">
                        <input
                            ref={inputRef}
                            type="text"
                            value={input}
